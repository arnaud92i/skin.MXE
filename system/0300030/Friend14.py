...
__XbmcFriend14__ = xbmc.getInfoLabel( '$INFO[Skin.string(Friend14)]' )
__XboxGamertag__ = __XbmcFriend14__.replace(" ","%20")
...
def GetGTNFO():
	...
	downloadImage( "http://avatar.xboxlive.com/avatar/" + __XboxGamertag__ + "/avatar-body.png", xbmc.translatePath( __GamerAvatarFolder__ ), __XbmcFriend14__ + '.png' )
	...
	xebi( 'XBMC.Skin.SetString(XboxLive.Gamer.Picture,' + __GamerPictureFolder__ + __XbmcFriend14__ + '.png)' )
	downloadImage( beautifulSoup.find( "img", { "id" : "Gamerpic" } )[ "src" ],  xbmc.translatePath( __GamerPictureFolder__ ), __XbmcFriend14__ + '.png' )
...
def main():
	...
	#if online == 1:
	nfo = GetGTNFO()
	xebi('XBMC.Notification(' + __XbmcFriend14__ + ' Signed ,in to Xbox Live)')
