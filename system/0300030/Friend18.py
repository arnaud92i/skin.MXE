...
__XbmcFriend18__ = xbmc.getInfoLabel( '$INFO[Skin.string(Friend18)]' )
__XboxGamertag__ = __XbmcFriend18__.replace(" ","%20")
...
def GetGTNFO():
	...
	downloadImage( "http://avatar.xboxlive.com/avatar/" + __XboxGamertag__ + "/avatar-body.png", xbmc.translatePath( __GamerAvatarFolder__ ), __XbmcFriend18__ + '.png' )
	...
	xebi( 'XBMC.Skin.SetString(XboxLive.Gamer.Picture,' + __GamerPictureFolder__ + __XbmcFriend18__ + '.png)' )
	downloadImage( beautifulSoup.find( "img", { "id" : "Gamerpic" } )[ "src" ],  xbmc.translatePath( __GamerPictureFolder__ ), __XbmcFriend18__ + '.png' )
...
def main():
	...
	#if online == 1:
	nfo = GetGTNFO()
	xebi('XBMC.Notification(' + __XbmcFriend18__ + ' Signed ,in to Xbox Live)')
