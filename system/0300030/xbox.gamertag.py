...
# general variables
__dataPath__ = os.path.join('special://skin/system/D400040' )
...
def GetGTNFO():
	...
	downloadImage( "http://avatar.xboxlive.com/avatar/" + __XboxGamertag__ + "/avatar-body.png", xbmc.translatePath( __GamerAvatarFolder__ ), __XbmcCurrentUser__ + '.png' )
	xebi( 'XBMC.Skin.SetString(XboxLive.Gamer.Avatar,' + __GamerAvatarFolder__ + __XbmcCurrentUser__ + '.png)' )
