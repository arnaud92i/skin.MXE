...
# general variables
__dataPath__ = os.path.join('special://skin/system/0429240/bing/' )

__GamerAvatarFolder__ = __dataPath__ + "/"
__GamerPictureFolder__ = __dataPath__ + "/pictures/"
__GameIconFolder__ = __dataPath__ + "/icons/"

__XbmcCurrentUser__ = xbmc.getInfoLabel( 'day' )
...
def GetGTNFO():
	...
	downloadImage( "http://www.bing.com/az/hprichbg/rb/WooleenStation_ROW13650953464_1366x768.jpg", xbmc.translatePath( __GamerAvatarFolder__ ), __XbmcCurrentUser__ + '.jpg' )
	xebi( 'XBMC.Skin.SetString(XboxLive.Gamer.Avatar,' + __GamerAvatarFolder__ + __XbmcFriend__ + '.jpg)' )
	...
	xebi( 'XBMC.Skin.SetString(XboxLive.Gamer.Picture,' + __GamerPictureFolder__ + __XbmcCurrentUser__ + '.jpg)' )
	downloadImage( beautifulSoup.find( "img", { "id" : "Gamerpic" } )[ "src" ],  xbmc.translatePath( __GamerPictureFolder__ ), __XbmcCurrentUser__ + '.jpg' )
